...
var FileSytem = /** @class */ (function () {
    function FileSytem() {
    }
    ;
    FileSytem.prototype.guardarImagenTemporal = function (file, userId) {
        var _this = this;
    ...
    FileSytem.prototype.generarNombreUnico = function (nombreOriginal) {
        //6.copy.jpg
    ...
    FileSytem.prototype.crearCarpetaUsuario = function (userId) {
    ...
    FileSytem.prototype.imagenesDeTempHaciaPost = function (userId) {
    ...
    FileSytem.prototype.obtenerImagenesEnTemp = function (userId) {
        var pathTemp = path_1.default.resolve(__dirname, '../uploads/', userId, 'temp');
        return fs_1.default.readdirSync(pathTemp) || [];
    };
    FileSytem.prototype.getFotoUrl = function (userId, img) {
